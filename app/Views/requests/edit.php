...
$errors = $errors ?? [];
$old = $old ?? [];
$requestId = (int) ($bloodRequest['id'] ?? 0);
?>
<!doctype html>
<html lang="en">
<head>
...
<body>
<h1>Edit Blood Request #<?= $requestId ?></h1>

<form action="<?= htmlspecialchars(app_url('/requests/' . $requestId . '/update'), ENT_QUOTES, 'UTF-8') ?>" method="post" novalidate>
    <div>
...
<p>
    <a href="<?= htmlspecialchars(app_url('/requests/history'), ENT_QUOTES, 'UTF-8') ?>">Back to My Blood Requests</a>
</p>
</body>
</html>
